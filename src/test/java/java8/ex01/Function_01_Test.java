...
public class Function_01_Test {
    ...
    private final Function<Integer, Person> intToPerson = (person) -> new Person("first_" + person, "last_" + person, person, "pass_" + person);
    // end::intToPerson[]
    ...
    private final Function<Person, Account> personToAccount = (person) -> new Account(person, 1000);
    // end::personToAccount[]
